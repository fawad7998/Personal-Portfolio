        ...
        <>
            ...
            <section className="text-white p-6 flex flex-col items-start justify-center h-screen bg-cover bg-center pt-24" style={{ backgroundImage: `url("/home.jpg")` }}>
                <div className="container mx-auto mt-6  text-left">
                    <h1 className="text-5xl font-bold mb-4">Hi, I'm Fawad Ahmad</h1>
                    <h2 className="text-3xl text-blue-500 mb-4">Frontend Developer</h2>
                    <p className="mb-8 max-w-lg">Passionate and detail-oriented Software Developer with expertise in various
                        programming languages and frameworks. Skilled in creating efficient software
                        solutions and committed to delivering top-notch work. Thrives in dynamic
                        environments, leveraging technical know-how to solve complex problems.
                        Experienced in front-end development, adept at integrating diverse technologies for
                        user-friendly applications. Excels in teamwork, understanding project needs, and
